...
{
    QMessageBox::information(this,"PoojaPriyankaVI 212218104042","This is information");
}

void Dialog::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply;
      reply = QMessageBox::question(this, "Pooja", "Do you play soccer?", QMessageBox::Yes|QMessageBox::No);
